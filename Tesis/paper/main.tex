...
\title{ShadowLedger: A Storage-Scarce Blockchain with Erasure-Coded Fragmented History and Storage-Weighted Consensus}
...
\input{secciones/02-background}
\input{secciones/03-related-work}
\input{secciones/04-system-overview}
\input{secciones/05-history}
\input{secciones/06-consensus}
\input{secciones/06b-storage-audit}
\input{secciones/07-fork-finality}
\input{secciones/08-economics}
\input{secciones/09-contracts}
\input{secciones/10-threat-model}
\input{secciones/11-implementation}
\input{secciones/12-evaluation}
\input{secciones/13-discussion}
\input{secciones/14-rationale}
\input{secciones/15-conclusion}
