...
``weight'' is chain length. Note the distinction from \emph{leader election}, which \emph{is}
storage-weighted (\S\ref{sec:consensus}): here the branch-selection weight remains chain length, and
extending storage weighting to fork choice is future work (\S\ref{sec:disc}).
